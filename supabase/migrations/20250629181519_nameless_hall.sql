/*
  # Fix public_dashboard NULL constraint issues
  ...
  1. Deleting timeline notes
  2. Updating the dashboard with triggers
  3. The profile_info is NULL for some reason
  
  ## Changes:
  1. Update the update_dashboard_for_user function to handle NULL profile_info
  2. Make profile_info default to empty JSON object if NULL
  3. Fix trigger functions to properly handle NULL values
  4. Add error handling to prevent constraint violations
*/

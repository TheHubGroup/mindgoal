/*
  # Fix Dashboard Service and Add User Activity Details
  
  This migration:
  1. Fixes NULL constraint issues in the public_dashboard table
  2. Updates trigger functions to properly handle DELETE operations
  3. Adds a function to get detailed activity data for a specific user
  4. Adds a function to get responses for specific activity types
  
  ## Changes:
  - Ensures all JSON columns have proper default values
  - Fixes any existing NULL values in the public_dashboard table
  - Creates get_user_activity_details function for detailed user data
  - Creates get_user_activity_responses function for specific activities
*/
